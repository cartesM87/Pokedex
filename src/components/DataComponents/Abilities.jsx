...
function Abilities({id}) {
    ...
    useEffect(()=>{getDataPokemon(setAbilitesData,id);},[]);
   
    const Abilities = abilitesData.abilities.map(async(val)=>{
        try{
            ...
            setAbilidades([...abilidades,description])
  ...
  return (
    <div className='bg-white bg-opacity-80 rounded-xl mt-7 mx-auto py-2 text-center w-[300px]'>
